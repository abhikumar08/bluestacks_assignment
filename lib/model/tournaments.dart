class PaginatedTournament {
  String cursor;
  Null tournamentCount;
  List<Tournament> tournaments;
  bool isLastBatch;

  PaginatedTournament({this.cursor, this.tournamentCount, this.tournaments, this.isLastBatch});

  PaginatedTournament.fromJson(Map<String, dynamic> json) {
    cursor = json['cursor'];
